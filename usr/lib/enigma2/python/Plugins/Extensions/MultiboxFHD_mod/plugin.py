...
def Plugins(**kwargs):
    return [PluginDescriptor(name=_("Multibox_mod FHD Configtool"), description=_("Personalize your Multibox_mod FHD (Skin by stein17)"), where = [PluginDescriptor.WHERE_PLUGINMENU],
