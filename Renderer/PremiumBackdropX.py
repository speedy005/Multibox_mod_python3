...
# for infobar,
# <widget source="session.Event_Now" render="PremiumBackdropX" position="100,100" size="680,1000" />
# <widget source="session.Event_Next" render="PremiumBackdropX" position="100,100" size="680,1000" />
# <widget source="session.Event_Now" render="PremiumBackdropX" position="100,100" size="680,1000" nexts="2" />
# <widget source="session.CurrentService" render="PremiumBackdropX" position="100,100" size="680,1000" nexts="3" />
# for ch,
# <widget source="ServiceEvent" render="PremiumBackdropX" position="100,100" size="680,1000" nexts="2" />
# <widget source="ServiceEvent" render="PremiumBackdropX" position="100,100" size="185,278" nexts="2" />
# for epg, event
# <widget source="Event" render="PremiumBackdropX" position="100,100" size="680,1000" />
# <widget source="Event" render="PremiumBackdropX" position="100,100" size="680,1000" nexts="2" />
# or put tag -->  path="/media/hdd/backdrop"
from __future__ import print_function
from Components.Renderer.Renderer import Renderer
from Components.Renderer.PremiumBackdropXDownloadThread import PremiumBackdropXDownloadThread
...
class BackdropDB(PremiumBackdropXDownloadThread):
    def __init__(self):
        PremiumBackdropXDownloadThread.__init__(self)
        self.logdbg = None
...
class BackdropAutoDB(PremiumBackdropXDownloadThread):
    def __init__(self):
        PremiumBackdropXDownloadThread.__init__(self)
        self.logdbg = None
...
class PremiumBackdropX(Renderer):
    def __init__(self):
        adsl = intCheck()
        if not adsl:
            return
    ...
    def logBackdrop(self, logmsg):
        try:
            w = open("/tmp/PremiumBackdropX.log", "a+")
            w.write("%s\n" % logmsg)
            w.close()
        except Exception as e:
