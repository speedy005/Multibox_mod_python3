...
# for infobar,
# <widget source="session.Event_Now" render="MXBackdropX" position="100,100" size="680,1000" />
# <widget source="session.Event_Next" render="MXBackdropX" position="100,100" size="680,1000" />
# <widget source="session.Event_Now" render="MXBackdropX" position="100,100" size="680,1000" nexts="2" />
# <widget source="session.CurrentService" render="MXBackdropX" position="100,100" size="680,1000" nexts="3" />
# for ch,
# <widget source="ServiceEvent" render="MXBackdropX" position="100,100" size="680,1000" nexts="2" />
# <widget source="ServiceEvent" render="MXBackdropX" position="100,100" size="185,278" nexts="2" />
# for epg, event
# <widget source="Event" render="MXBackdropX" position="100,100" size="680,1000" />
# <widget source="Event" render="MXBackdropX" position="100,100" size="680,1000" nexts="2" />
# or put tag -->  path="/media/hdd/backdrop"
from __future__ import print_function
from Components.Renderer.Renderer import Renderer
from Components.Renderer.MXBackdropXDownloadThread import MXBackdropXDownloadThread
...
class BackdropDB(MXBackdropXDownloadThread):
    def __init__(self):
        MXBackdropXDownloadThread.__init__(self)
        self.logdbg = None
...
class BackdropAutoDB(MXBackdropXDownloadThread):
    def __init__(self):
        MXBackdropXDownloadThread.__init__(self)
        self.logdbg = None
    ...
    def logAutoDB(self, logmsg):
        try:
            w = open("/tmp/MXBackdropAutoDB.log", "a+")
            w.write("%s\n" % logmsg)
            w.close()
        except Exception as e:
