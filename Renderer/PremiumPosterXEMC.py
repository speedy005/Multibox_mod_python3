...
#
# for emc plugin,
# <widget source="Service" render="PremiumPosterXEMC" position="100,100" size="185,278" />
...
class PosterDBEMC(AglarePosterXDownloadThread):
	...
	def logDB(self, logmsg):
		if self.logdbg:
			w = open(path_folder + "PremiumPosterXEMC.log", "a+")
			w.write("%s\n"%logmsg)
			w.close()
...
class PremiumPosterXEMC(Renderer):
	def __init__(self):
