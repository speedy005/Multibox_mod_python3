...
# channelselections
# <widget render="LukaGenre" source="ServiceEvent" position="793,703" size="300,438" zPosition="3" transparent="1" />
# infobar
# <widget render="LukaGenre" source="session.Event_Now" position="54,315" size="300,438" zPosition="22" transparent="1" />
# <widget render="LukaGenre" source="session.Event_Next" position="54,429" size="300,438" zPosition="22" transparent="1" />
    ...
    def delay(self):
        ...
        if self.event and self.event != 'None' or self.event is not None:
            try:
                ...
                print('LukaGenre error get event: ',  str(e))
                pass
