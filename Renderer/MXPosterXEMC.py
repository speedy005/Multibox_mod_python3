...
#
# for emc plugin,
# <widget source="Service" render="MXPosterXEMC" position="100,100" size="185,278" />
...
class PosterDBEMC(MXPosterXDownloadThread):
	def __init__(self):
	...
	def logDB(self, logmsg):
		if self.logdbg:
			w = open(path_folder + "MXPosterXEMC.log", "a+")
			w.write("%s\n"%logmsg)
			w.close()
