...
# for infobar,
# <widget source="session.Event_Now" render="LukaPosterX" position="100,100" size="185,278" />
# <widget source="session.Event_Next" render="LukaPosterX" position="100,100" size="100,150" />
# <widget source="session.Event_Now" render="LukaPosterX" position="100,100" size="185,278" nexts="2" />
# <widget source="session.CurrentService" render="LukaPosterX" position="100,100" size="185,278" nexts="3" />

# for ch,
# <widget source="ServiceEvent" render="LukaPosterX" position="100,100" size="185,278" />
# <widget source="ServiceEvent" render="LukaPosterX" position="100,100" size="185,278" nexts="2" />

# for epg, event
# <widget source="Event" render="LukaPosterX" position="100,100" size="185,278" />
# <widget source="Event" render="LukaPosterX" position="100,100" size="185,278" nexts="2" />
...
class PosterDB(LukaPosterXDownloadThread):
    def __init__(self):
...
class PosterAutoDB(LukaPosterXDownloadThread):
    def __init__(self):
        LukaPosterXDownloadThread.__init__(self)
        self.logdbg = None
        self.pstcanal = None
