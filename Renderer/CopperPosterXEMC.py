...
#
# for emc plugin,
# <widget source="Service" render="CopperPosterXEMC" position="100,100" size="185,278" />
...
class PosterDBEMC(CopperPosterXDownloadThread):
	def __init__(self):
	...
	def logDB(self, logmsg):
		if self.logdbg:
			w = open(path_folder + "CopperPosterXEMC.log", "a+")
			w.write("%s\n"%logmsg)
			w.close()
...
class CopperPosterXEMC(Renderer):
	def __init__(self):
