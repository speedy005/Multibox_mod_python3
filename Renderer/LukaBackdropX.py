...
# for infobar,
# <widget source="session.Event_Now" render="LukaBackdropX" position="100,100" size="680,1000" />
# <widget source="session.Event_Next" render="LukaBackdropX" position="100,100" size="680,1000" />
# <widget source="session.Event_Now" render="LukaBackdropX" position="100,100" size="680,1000" nexts="2" />
# <widget source="session.CurrentService" render="LukaBackdropX" position="100,100" size="680,1000" nexts="3" />
# for ch,
# <widget source="ServiceEvent" render="LukaBackdropX" position="100,100" size="680,1000" nexts="2" />
# <widget source="ServiceEvent" render="LukaBackdropX" position="100,100" size="185,278" nexts="2" />
# for epg, event
# <widget source="Event" render="LukaBackdropX" position="100,100" size="680,1000" />
# <widget source="Event" render="LukaBackdropX" position="100,100" size="680,1000" nexts="2" />
# or put tag -->  path="/media/hdd/backdrop"
from __future__ import print_function
from Components.Renderer.Renderer import Renderer
from Components.Renderer.LukaBackdropXDownloadThread import LukaBackdropXDownloadThread
...
import traceback
import datetime
from .LukaConverlibr import convtext
...
class BackdropDB(LukaBackdropXDownloadThread):
    def __init__(self):
        LukaBackdropXDownloadThread.__init__(self)
        self.logdbg = None
        self.pstcanal = None
...
class BackdropAutoDB(LukaBackdropXDownloadThread):
    def __init__(self):
        LukaBackdropXDownloadThread.__init__(self)
        self.logdbg = None
        self.pstcanal = None
