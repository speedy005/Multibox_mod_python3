...
# for infobar,
# <widget source="session.Event_Now" render="PremiumPosterX" position="100,100" size="185,278" />
# <widget source="session.Event_Next" render="PremiumPosterX" position="100,100" size="100,150" />
# <widget source="session.Event_Now" render="PremiumPosterX" position="100,100" size="185,278" nexts="2" />
# <widget source="session.CurrentService" render="PremiumPosterX" position="100,100" size="185,278" nexts="3" />

# for ch,
# <widget source="ServiceEvent" render="PremiumPosterX" position="100,100" size="185,278" />
# <widget source="ServiceEvent" render="PremiumPosterX" position="100,100" size="185,278" nexts="2" />

# for epg, event
# <widget source="Event" render="PremiumPosterX" position="100,100" size="185,278" />
# <widget source="Event" render="PremiumPosterX" position="100,100" size="185,278" nexts="2" />
