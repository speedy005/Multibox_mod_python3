...
# for infobar,
# <widget source="session.Event_Now" render="CopperPosterX" position="100,100" size="185,278" />
# <widget source="session.Event_Next" render="CopperPosterX" position="100,100" size="100,150" />
# <widget source="session.Event_Now" render="CopperPosterX" position="100,100" size="185,278" nexts="2" />
# <widget source="session.CurrentService" render="CopperPosterX" position="100,100" size="185,278" nexts="3" />

# for ch,
# <widget source="ServiceEvent" render="CopperPosterX" position="100,100" size="185,278" />
# <widget source="ServiceEvent" render="CopperPosterX" position="100,100" size="185,278" nexts="2" />

# for epg, event
# <widget source="Event" render="CopperPosterX" position="100,100" size="185,278" />
# <widget source="Event" render="CopperPosterX" position="100,100" size="185,278" nexts="2" />
# or put tag -->  path="/media/hdd/poster"
from __future__ import print_function
from Components.Renderer.Renderer import Renderer
from Components.Renderer.CopperPosterXDownloadThread import CopperPosterXDownloadThread
...
class PosterDB(CopperPosterXDownloadThread):
    def __init__(self):
        CopperPosterXDownloadThread.__init__(self)
        self.logdbg = None
...
class PosterAutoDB(CopperPosterXDownloadThread):
    def __init__(self):
        CopperPosterXDownloadThread.__init__(self)
        self.logdbg = None
...
class CopperPosterX(Renderer):
    ...
    def logPoster(self, logmsg):
        try:
            w = open("/tmp/CopperPosterX.log", "a+")
            w.write("%s\n" % logmsg)
            w.close()
        except Exception as e:
