...
class xDreamy_mod_flipclock_infobars_gelb(Renderer):
    ...
    def changed(self, what):
        if not self.suspended:
            ...
            if 'H1' in value:
                ...
                value = 0
            self.instance.setPixmapFromFile('/usr/share/enigma2/xDreamy_mod/flipclock/flipclock_led/gelb/' + str(value) + '.png')
