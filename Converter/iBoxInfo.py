...
class iBoxInfo(Poll, Converter, object):
	Boxtype = 0			# Output: "AX 4K-BOX HD51 : OpenATV 7.0"
	CpuInfo = 1			# Output: "ARMv7, 1500 MHz (4 cores)"
	HddTemp = 2			# Output: "HDD: Temp:42°C"
	TempInfo = 3		# Output: "52°C" (CPU/board temperature)
	FanInfo = 4			# Output: "Fan: 1200 RPM" (or PWM %)
	Upinfo = 5			# Output: "Time in work: 2 days 5 hours 30 minutes"
	CpuLoad = 6			# Output: "CPU Load: 0.75" (1-min avg)
	CpuSpeed = 7		# Output: "CPU Speed: 1500 MHz"
	SkinInfo = 8		# Output: "Skin: MetrixHD/skin.xml"
	TimeInfo = 9		# Output: "+2" (GMT offset hours)
	TimeInfo2 = 10		# Output: "Timezone: GMT+02:00"
	TimeInfo3 = 11		# Output: "Timezone: Europe/Berlin"
	TimeInfo4 = 12		# Output: "Part~of~the~light:Europe" (Depends on config)
