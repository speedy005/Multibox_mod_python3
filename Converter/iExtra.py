...
class iExtra(Poll, Converter):
    ...
    TEMPERATURE = 0             # Output: "52°C" (CPU/board temperature)
    HDDTEMP = 1                 # Output: "HDD Temp: 42°C" (or "HDD idle or N/A")
    CPULOAD = 2                 # Output: "CPU : 0.75" (1-min load average)
    CPUSPEED = 3                # Output: "CPU Speed: 1500 MHz"
    FANINFO = 4                 # Output: "Speed: 1200 V: 12 PWM: 80" (or "Fan Info: N/A")
    UPTIME = 5                  # Output: "Uptime: 2d 5h 30m" (short) or "Uptime: 2 days, 5 hrs, 30 mins"
    IPLOCAL = 6                 # Output: "Lan Ip 192.168.1.100"
    IPWAN = 7                   # Output: "Local Ip 84.203.xxx.xxx" (public IP)
