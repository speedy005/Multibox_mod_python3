...
novpnfile = '/usr/share/enigma2/Aglare-FHD/samba/novpn.txt'
isvpnfile = '/usr/share/enigma2/Aglare-FHD/samba/isvpn.txt'
...
class Luka_FHD_UTIPdata(Poll, Converter, object):
