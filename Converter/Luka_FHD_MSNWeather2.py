# -*- coding: UTF-8 -*-
# compatible for py2 and py3 bei speedy005
...
class Luka_FHD_MSNWeather2(Poll, Converter, object):
...
#
		...
		if light >= 0 and light <= 5:
			...
			pic = '10'
			phase = _('Wachsender Halbmond')
			if trend == -1:
				pic = '010'
				phase = _('Abnehmender Halbmond')
			...
			pic = '50'
			phase = _('Erstes Viertel')
			if trend == -1:
				pic = '050'
				phase = _('Letztes Viertel')
			...
			pic = '60'
			phase = _('Zunehmender Dreiviertelmond')
			if trend == -1:
				pic = '060'
				phase = _('Abnehmender Dreiviertelmond')
