...
class LukaFrontendInfo(Converter, object):
	BER = 0
	SNR = 1
	AGC = 2
	LOCK = 3
...
<screen
	...
	<widget
		...
		valign="center">
		<convert type="LukaFrontendInfo">SNR</convert>
	</widget>
	...
	<widget
		...
		valign="center">
		<convert type="LukaFrontendInfo">AGC</convert>
	</widget>
	...
	<widget
		...
		valign="center">
		<convert type="LukaFrontendInfo">TYPE</convert>
	</widget>
	...
	<widget
		...
		foregroundColor="red"
		valign="center">
		<convert type="LukaFrontendInfo">BER</convert>
	</widget>
