...
novpnfile = '/usr/share/enigma2/xDreamy_mod/samba/novpn.txt'
isvpnfile = '/usr/share/enigma2/xDreamy_mod/samba/isvpn.txt'
...
class xDreamy_mod_UTIPdata(Poll, Converter, object):
