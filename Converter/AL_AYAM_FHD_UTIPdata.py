...
novpnfile = '/usr/share/enigma2/AL_AYAM_FHD/samba/novpn.txt'
isvpnfile = '/usr/share/enigma2/AL_AYAM_FHD/samba/isvpn.txt'
...
class AL_AYAM_FHD_UTIPdata(Poll, Converter, object):
